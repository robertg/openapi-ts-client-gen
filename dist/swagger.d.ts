...
export declare type Parameter = IBodyParameter | IFormDataParameter | IQueryParameter | IPathParameter | IHeaderParameter;
...
export interface IResponse {
    ...
    schema?: ISchema;
    headers?: {
        [headerName: string]: IHeader;
    };
    examples?: {
        [exampleName: string]: IExample;
    };
}
...
export declare type Secuirty = IBasicAuthenticationSecurity | IOAuth2AccessCodeSecurity | IOAuth2ApplicationSecurity | IOAuth2ImplicitSecurity | IOAuth2PasswordSecurity | IApiKeySecurity;
export interface ISpec {
    ...
    produces?: [string];
    paths: {
        [pathName: string]: IPath;
    };
    definitions?: {
        [definitionsName: string]: ISchema;
    };
    parameters?: {
        [parameterName: string]: IBodyParameter | IQueryParameter;
    };
    responses?: {
        [responseName: string]: IResponse;
    };
